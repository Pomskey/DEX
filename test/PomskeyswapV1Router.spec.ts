...
import { TestPomskeyswapV1Router } from '../typechain/TestPomskeyswapV1Router'
...
describe('PomskeyswapV1Pool', () => {
  ...
  let pool0: MockTimePomskeyswapV1Pool
  let pool1: MockTimePomskeyswapV1Pool
  ...
  let swapTargetCallee: TestPomskeyswapV1Callee
  let swapTargetRouter: TestPomskeyswapV1Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimePomskeyswapV1Pool, any]> => {
