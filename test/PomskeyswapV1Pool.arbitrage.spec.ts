...
import { PomskeyswapV1PoolSwapTest } from '../typechain/PomskeyswapV1PoolSwapTest'
...
describe('PomskeyswapV1Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('PomskeyswapV1PoolSwapTest')
            const tester = (await testerFactory.deploy()) as PomskeyswapV1PoolSwapTest
          ...
          let tester: PomskeyswapV1PoolSwapTest
